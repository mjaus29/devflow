...
export const AskQuestionSchema = z.object({
  ...
  tags: z
    .array(z.string().min(1, "Tag must have at least 1 character.").max(15, "Tag must not exceed 15 characters."))
...
export const AIAnswerSchema = z.object({
  ...
  content: z.string().min(100, "Question description must have Minimum of 100 characters."),
  userAnswer: z.string().optional(),
});

export const CreateVoteSchema = z.object({
  targetId: z.string().min(1, "Target ID is required"),
  targetType: z.enum(["question", "answer"], "Invalid target type. Must be 'question' or 'answer'."),
  voteType: z.enum(["upvote", "downvote"], "Invalid vote type. Must be 'upvote' or 'downvote'."),
});
