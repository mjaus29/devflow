...
const MobileNavigation = async () => {
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="background-light900_dark200 border-none px-5 py-5">
              ...
              <SheetClose asChild>
                ...
                >
                  <Button
                    type="submit"
                    variant="ghost"
                    className="base-medium w-fit px-4 py-3 shadow-none hover:bg-transparent focus-visible:ring-0 focus-visible:border-0"
                  >
